...
_EXCLUDED_URL_PATTERNS = (
    ...
    # Районные поддомены mos.ru (novogireevo.mos.ru, uvao.mos.ru, sao.mos.ru и
    # т.д.) — растиражированные районные новости/справочники: одна и та же новость
    # («Ветераны боевых действий столичного региона...») приходит с 5-10 районов,
    # вручную отклоняется каждую итерацию (инциденты #61-#331, 08.09). Официальные
    # документы Москвы покрывает адаптер www.mos.ru/authority/documents; www.mos.ru
    # (и apex) в обработке остаётся, районные поддомены — только источник тиражей из
    # выдачи Yandex Search.
    re.compile(r"^https?://(?!www\.)[a-z0-9.-]+\.mos\.ru/"),
)
